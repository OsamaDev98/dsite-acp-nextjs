export const sidebarMenu = [
  ...
  },
  {
    ...
    icon: (
      <svg
        ...
        width="27.142"
        height="19.949"
        viewBox="0 0 27.142 19.949"
      >
        <g
          id="Group_9767"
          data-name="Group 9767"
          transform="translate(-112.25 -9.001)"
        >
          <g
            id="Iconly_Light_Image"
            data-name="Iconly/Light/Image"
            transform="translate(113 9.751)"
          >
            <g id="Image" transform="translate(-6.49 -0.751)">
              <path
                id="Stroke_1"
                data-name="Stroke 1"
                d="M3.642,13.712A3.527,3.527,0,0,1,0,9.884V3.827A3.53,3.53,0,0,1,3.642,0Z"
                transform="translate(6.49 3.488)"
                fill="none"
                className="a"
                strokeLinecap="round"
            ...
            <g id="Image-2" data-name="Image" transform="translate(22 2.749)">
              <path
                id="Stroke_1-2"
                data-name="Stroke 1"
                d="M0,13.712A3.527,3.527,0,0,0,3.642,9.884V3.827A3.53,3.53,0,0,0,0,0Z"
            ...
            <g
              id="Image-3"
              data-name="Image"
              transform="translate(2.51 -0.751)"
            >
              <path
                id="Stroke_1-3"
                data-name="Stroke 1"
  ...
  },
  {
    ...
    icon: (
      <svg
        ...
        width="21.399"
        height="19.874"
        viewBox="0 0 21.399 19.874"
      >
        <g
          id="Group_9768"
          data-name="Group 9768"
          transform="translate(-83.5 -5.42)"
        >
          <g
            id="Iconly_Light_Paper"
            data-name="Iconly/Light/Paper"
            transform="translate(84.25 6.17)"
          >
            <g id="Paper" transform="translate(6.25 -0.741)">
              <path
                id="Stroke_1"
                data-name="Stroke 1"
                d="M8.7,0H3.3A52.1,52.1,0,0,1,8.7.114c1.028.011-.189,2.743-.094,7.15-.074.737.033,1.865,0,2.966A30.088,30.088,0,0,0,8.7,15.174c0,.009-.014-.056.307,0a5.329,5.329,0,0,0,.8.048A3.224,3.224,0,0,0,12.9,11.978v-7.6Z"
                transform="translate(0.75 0.76)"
                fill="none"
                className="a"
                strokeLinecap="round"
                strokeLinejoin="round"
              ...
              <path
                id="Stroke_3"
                data-name="Stroke 3"
                d="M0,0V2.413A2.135,2.135,0,0,0,2.13,4.548c1.092,0,2.21,0,2.285,0"
                transform="translate(9.23 0.75)"
                fill="none"
                className="a"
                strokeLinecap="round"
                strokeLinejoin="round"
            ...
            <g
              id="Paper-2"
              data-name="Paper"
              transform="translate(-0.75 -0.741)"
            >
              <path
                id="Stroke_1-2"
                data-name="Stroke 1"
  ...
  },
  {
    ...
    icon: (
      <svg
        ...
        strokeLinejoin="round"
      >
        <path className="a" d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" />
        <circle className="a" cx="9" cy="7" r="4" />
        <path className="a" d="M22 21v-2a4 4 0 0 0-3-3.87" />
        <path className="a" d="M16 3.13a4 4 0 0 1 0 7.75" />
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <ellipse className="a" cx="12" cy="5" rx="9" ry="3" />
        <path className="a" d="M3 12a9 3 0 0 0 5 2.69" />
        <path className="a" d="M21 9.3V5" />
        <path className="a" d="M3 5v14a9 3 0 0 0 6.47 2.88" />
        <path className="a" d="M12 12v4h4" />
        <path
          className="a"
